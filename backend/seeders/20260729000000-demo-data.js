  ...
  up: async (queryInterface, Sequelize) => {
    ...
    const groups = [
      ...
      },
      {
        ...
        created_by: 4,
        invite_token: "manali-trip-uuid-2",
        created_at: new Date(),
        updated_at: new Date(),
      },
    ];
    ...
    const generateExpenses = (groupId, memberIds, configs, descPrefix) => {
      configs.forEach((cfg, index) => {
        ...
        if (cfg.type === "equal") {
          ...
          const percentageAmounts = distributeRemainder(
            initialAmounts,
            remainder,
          );
          memberIds.forEach((mId, i) => {
