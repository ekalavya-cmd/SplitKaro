...
_(Note: Data tables, amounts, and split percentages MUST use `mono-data` for vertical alignment.)_
...
_All buttons must use Title Case for labels (no all-caps)._
...
- **Category Tags (Bento Box)**:
  ...
  - _Food_: `bg-[#FFF3E0] text-[#E65100] border-[#FFE0B2]`
  - _Travel_: `bg-[#E3F2FD] text-[#1565C0] border-[#BBDEFB]`
  - _Stay_: `bg-primary-fixed text-on-primary-fixed border-primary-fixed-dim`
  - _Entertainment_: `bg-[#F3E5F5] text-[#6A1B9A] border-[#E1BEE7]`
